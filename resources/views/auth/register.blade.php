            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/register">
                        ...
                        <hr>
                        <h5>Localisation</h5>
                        <p class="text-muted">Ces informations nous aident à vous proposer des événements à proximité.</p>
                        ...
                        <div class="mb-3 row">
                            <label for="postal_code" class="col-md-4 col-form-label text-md-end">Code postal</label>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3 row">
                            <label for="country" class="col-md-4 col-form-label text-md-end">Pays</label>
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control @error('country') is-invalid @enderror" name="country" value="{{ old('country', 'France') }}" autocomplete="country">
                                @error('country')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
