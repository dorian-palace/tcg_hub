        ...
        <div class="bg-[rgb(31,41,55)] rounded-lg shadow-lg p-6">
            ...
            <form method="POST" action="{{ route('games.store') }}" class="space-y-6" enctype="multipart/form-data">
                ...
                <div class="flex justify-end">
                    <button type="submit"
                        class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                        Ajouter le jeu
                    </button>
                </div>
            </form>
