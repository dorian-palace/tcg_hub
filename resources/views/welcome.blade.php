...
@section('content')
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105">
                    <div class="p-6">
                        <div class="text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-4">Recherche géolocalisée</h3>
                            <p class="text-gray-600 mb-4">Trouvez des événements TCG près de chez vous grâce à notre système de recherche par distance.</p>
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105">
                    <div class="p-6">
                        <div class="text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-4">Échange de cartes</h3>
                            <p class="text-gray-600 mb-4">Échangez ou vendez vos cartes avec d'autres collectionneurs passionnés.</p>
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105">
                    <div class="p-6">
                        <div class="text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-4">Tournois et événements</h3>
                            <p class="text-gray-600 mb-4">Participez à des tournois ou organisez vos propres événements TCG.</p>
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-8">
                <h2 class="text-3xl font-bold text-gray-900">Jeux populaires</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="{{ route('games.index') }}?search=pokemon" class="group">
                    <div class="bg-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 h-full">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold mb-2 group-hover:text-blue-400 transition-colors text-gray-900">Pokémon TCG</h3>
                            <p class="text-gray-600 mb-4">Le jeu de cartes à collectionner Pokémon.</p>
                            <div class="flex gap-2">
                                <span class="bg-blue-400 text-white px-3 py-1 rounded-full text-sm">+1000 cartes</span>
                                <span class="bg-light-secondary text-light-text px-3 py-1 rounded-full text-sm">+50 événements</span>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('games.index') }}?search=magic" class="group">
                    <div class="bg-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 h-full">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold mb-2 group-hover:text-blue-400 transition-colors text-gray-900">Magic: The Gathering</h3>
                            <p class="text-gray-600 mb-4">Le premier jeu de cartes à collectionner.</p>
                            <div class="flex gap-2">
                                <span class="bg-blue-400 text-white px-3 py-1 rounded-full text-sm">+5000 cartes</span>
                                <span class="bg-light-secondary text-light-text px-3 py-1 rounded-full text-sm">+100 événements</span>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('games.index') }}?search=yugioh" class="group">
                    <div class="bg-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 h-full">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold mb-2 group-hover:text-blue-400 transition-colors text-gray-900">Yu-Gi-Oh!</h3>
                            <p class="text-gray-600 mb-4">Le célèbre jeu de cartes inspiré du manga.</p>
                            <div class="flex gap-2">
                                <span class="bg-blue-400 text-white px-3 py-1 rounded-full text-sm">+3000 cartes</span>
                                <span class="bg-light-secondary text-light-text px-3 py-1 rounded-full text-sm">+80 événements</span>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('games.index') }}?search=one+piece" class="group">
                    <div class="bg-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 h-full">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold mb-2 group-hover:text-blue-400 transition-colors text-gray-900">One Piece Card Game</h3>
                            <p class="text-gray-600 mb-4">Le jeu de cartes basé sur l'univers de One Piece.</p>
                            <div class="flex gap-2">
                                <span class="bg-blue-400 text-white px-3 py-1 rounded-full text-sm">+500 cartes</span>
                                <span class="bg-light-secondary text-light-text px-3 py-1 rounded-full text-sm">+30 événements</span>
                            </div>
                        </div>
                    </div>
                </a>
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gray-50 rounded-lg overflow-hidden shadow-lg p-8 md:p-12">
